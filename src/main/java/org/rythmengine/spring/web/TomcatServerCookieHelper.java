...
/**
 * The source code of this utility class is copied from http://grepcode.com/file_/repository.springsource.com/org.apache.coyote/com.springsource.org.apache.coyote/6.0.24/org/apache/tomcat/util/http/ServerCookie.java/?v=source
 */
public class TomcatServerCookieHelper implements Serializable {
    ...
    public TomcatServerCookieHelper() {
    }
    ...
    public static boolean isToken(String value, String literals) {
        String tspecials = (literals==null? TomcatServerCookieHelper.tspecials:literals);
    ...
    public static boolean isToken2(String value, String literals) {
        String tspecials2 = (literals==null? TomcatServerCookieHelper.tspecials2:literals);
        if( value==null) return true;
        int len = value.length();
                                          ...
                                          boolean isHttpOnly)
    {
        ...
        if (path!=null) {
            ...
            if (version==0) {
                ...
                maybeQuote2(version, buf, path, TomcatServerCookieHelper.tspecials2NoSlash, false);
            }
        }
