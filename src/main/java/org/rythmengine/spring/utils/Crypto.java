...
public class Crypto {
    ...
    public static String sign(String message) {
        return sign(message, RythmConfigurer.getSecretKey().getBytes());
    }
    ...
    public static String encryptAES(String value) {
        return encryptAES(value, RythmConfigurer.getSecretKey().substring(0, 16));
    }
    ...
    public static String encryptAES(String value, String privateKey) {
        try {
            ...
            return String.valueOf(Hex.encode(cipher.doFinal(value.getBytes())));
        } catch (Exception ex) {
            throw new RuntimeException(ex);
        }
    }
    ...
    public static String decryptAES(String value) {
        return decryptAES(value, RythmConfigurer.getSecretKey().substring(0, 16));
    }
    ...
    public static String decryptAES(String value, String privateKey) {
        try {
            ...
            return new String(cipher.doFinal(Hex.decode(value)));
        } catch (Exception ex) {
            throw new RuntimeException(ex);
        }
    }
